...
<html class="no-js" lang="en">
	...
	<link href="http://fonts.cdnfonts.com/css/monotype-corsiva" rel="stylesheet">
		...
		<div class="container forgotpassword-container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p>Enter your Email Id, password and password confirmation to verify and reset!</p>
				</div>
			</div>
			<div class="row animate-box">
						...
						<form class="form-inline">
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input type="password" name="password_confirmation" class="form-control" id="email" placeholder="Confirm Password">
								</div>
							</div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2004 Rana Marriage Bureau. All Rights Reserved.</small> 
