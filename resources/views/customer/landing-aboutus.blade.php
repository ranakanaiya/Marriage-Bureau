...
<html class="no-js" lang="en">
	...
	<title>Rana Marriage Bureau - About Us</title>
    ...
    #fh5co-testimonial, #fh5co-services, #fh5co-started, #fh5co-footer, #fh5co-event, #fh5co-couple-story, #fh5co-couple, #fh5co-gallery, .fh5co-section {
    	padding-top: 1.5em;
    }
    .fh5co-heading p {
    	padding-left: 275px;
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>About Us</h1>
							<p><a href="{{asset('')}}" class="btn btn-default btn-sm">Home</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="fh5co-heading animate-box">
					...
					<p align="justify">Rana Marriage Bureau is an independant organization operating for all caste from around 15 years. As a part of woman empowerment, Rana Marriage Bureau provides service to find marital perfect match, which is FREE for woman and ₹ 205 for man.</p>
				</div>
			</div>
			<div class="row" style="margin-top: 40px;">
				<div class="fh5co-heading fh5co-heading-2 animate-box">
